...
class APIKeyDocument(Document):
    ...
    id: str  # type: ignore[assignment]  # Maps to MongoDB _id (automatically unique and indexed)
    key_material: str
...
async def initialize_beanie_models(database: AsyncIOMotorDatabase[Any]) -> None:
